            ...
            <li class="media">
                <div class="media-left">
                    <a href="{{ route('users.show', [$topic->user_id]) }}">
                        <img class="media-object img-thumbnail" style="width: 52px; height: 52px" src="{{ $topic->user->avatar }}" title="{{ $topic->user->name }}" alt="{{ $topic->user->name }}">
                    </a>
                </div>
...
@else
    <div class="empty-block">没数据啊！(～￣▽￣)～ </div>
@endif    